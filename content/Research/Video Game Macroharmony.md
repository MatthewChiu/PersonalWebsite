...
### [Video](https://www.youtube.com/watch?v=agFlat6AG58)
```python
class CoAuthor
...
### TL;DR
Much of the music in the Mario and Legend of Zelda franchises are written by Koji Kondo. But yet, they sound so unique to each game _and_ within the franchise. We built a dataset and studied similarities and differences between their harmonic language using the discrete #fourierTransform 
